        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 759*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19.99*fem, 23*fem, 22.22*fem, 8.33*fem),
                width: 390*fem,
                height: 85*fem,
                decoration: BoxDecoration (
                  color: Color(0xffffffff),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 2.47*fem, 49.42*fem, 0.83*fem),
                      height: double.infinity,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 50.38*fem, 0.83*fem),
                      height: 52.83*fem,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
                            // group34m (2327:618)
                            margin: EdgeInsets.fromLTRB(0.81*fem, 0*fem, 0*fem, 4.17*fem),
                            width: 27.58*fem,
                            height: 28.67*fem,
                            child: Image.asset(
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 3*fem, 54.98*fem, 0*fem),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
            ...
            Positioned(
              ...
              top: 206*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(28*fem, 19*fem, 2*fem, 12*fem),
                width: 309*fem,
                height: 110*fem,
                decoration: BoxDecoration (
                  color: Color(0xffffffff),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 77.5*fem, 16*fem),
                      width: double.infinity,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 70*fem, 16*fem),
                      width: double.infinity,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
