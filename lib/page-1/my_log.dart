                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(5*fem, 22.93*fem, 0*fem, 0*fem),
                          width: double.infinity,
                          child: Column(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          // vectorNEh (0:182)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 12.11*fem, 27.46*fem),
                          width: 47.75*fem,
                          height: 113.01*fem,
                          decoration: BoxDecoration (
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 12.11*fem, 0*fem),
                          width: 53.75*fem,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                // groupjzM (0:192)
                                margin: EdgeInsets.fromLTRB(14.02*fem, 0*fem, 18.72*fem, 0*fem),
                                width: double.infinity,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                // vectorvow (0:186)
                                margin: EdgeInsets.fromLTRB(0*fem, 56*fem, 0*fem, 0.73*fem),
                                width: double.infinity,
                                height: 84.76*fem,
                                decoration: BoxDecoration (
                              ...
                              Container(
                                // grouprhb (0:188)
                                margin: EdgeInsets.fromLTRB(15.8*fem, 0*fem, 16.95*fem, 0*fem),
                                width: double.infinity,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 27.91*fem, 0.6*fem),
                            width: 25.09*fem,
                            height: 22.4*fem,
                            child: Image.asset(
