        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(9 * fem, 12 * fem, 7 * fem, 70 * fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        7 * fem, 0 * fem, 0 * fem, 35 * fem),
                    padding: EdgeInsets.fromLTRB(
                        18 * fem, 22 * fem, 18 * fem, 37 * fem),
                    width: 367 * fem,
                    decoration: BoxDecoration(
                      color: Color(0xffffffff),
                  ...
                  Container(
                    // Lid (2327:358)
                    margin: EdgeInsets.fromLTRB(
                        42 * fem, 0 * fem, 16 * fem, 0 * fem),
                    padding: EdgeInsets.fromLTRB(
                        24 * fem, 24 * fem, 24 * fem, 43.5 * fem),
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: Color(0xffffffff),
