...
class _SceneState extends State<TodoScreen> {
  ...
  final List<String> _todos = []; // 사용자가 입력한 To Do 목록(미완료)
  final List<String> _completedTodos = []; // 완료된 할 일 목록
  ...
  void _addTodo() {
    ...
    setState(() {
      ...
      if (todo.isNotEmpty) {
        ...
        submitTodoToServer(
            'http://your-server-url.com', todo, currentDate, false);
      }
    });
  }
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap:
                                          _showAddTodoDialog, // 이미지를 탭하면 _showAddTodoDialog 함수 호출
                                      child: Container(
                                        // group73E4R (2327:695)
                                        margin: EdgeInsets.fromLTRB(0 * fem,
                                            4 * fem, 17.5 * fem, 0 * fem),
                                        padding: EdgeInsets.fromLTRB(4.31 * fem,
                                            4.85 * fem, 4.85 * fem, 4.31 * fem),
                                        decoration: BoxDecoration(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Dismissible(
                                ...
                                background: Container(
                                    color: Colors.redAccent), // 스와이프 시 배경 색상
                                child: Container(
                                  width: 358 * fem,
                                  height: 39 * fem,
                                  margin: EdgeInsets.only(
                                      bottom: 10 * fem), // 각 할 일 사이의 간격
                                  child: Stack(
                                    children: [
                                      Positioned(
                                        left: 3.5 * fem,
