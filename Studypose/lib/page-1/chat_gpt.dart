...
class _SceneState extends State<GptScreen> {
  ...
  final List<String> _userQuestions = []; // 사용자 질문 목록
  ...
  double calculateTextHeight(String text, double width, TextStyle style) {
    // 적절한 box height를 위해 사용자가 입력한 문자열 길이를 계산
                  ...
                  Positioned(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(
                          11 * fem, 20.13 * fem, 11 * fem, 21.19 * fem),
                      width: 272 * fem,
                      height: 71 * fem,
                      decoration: BoxDecoration(
                        color: Color(0xffffffff),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.fromLTRB(
                                  10 * fem, 0 * fem, 1.91 * fem, 2.39 * fem),
                              width: 25.09 * fem,
                              height: 23.81 * fem,
                              child: Image.asset(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    // groupEam (2313:74)
                                    margin: EdgeInsets.fromLTRB(2.4 * fem,
                                        0 * fem, 0 * fem, 8.33 * fem),
                                    width: 25.98 * fem,
                                    height: 22.33 * fem,
                                    child: Image.asset(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    // vectoroXP (2313:81)
                                    margin: EdgeInsets.fromLTRB(0.45 * fem,
                                        0 * fem, 0 * fem, 4.83 * fem),
                                    width: 29 * fem,
                                    height: 28 * fem,
                                    child: Image.asset(
