                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => Subject.showSubjectPicker(
                            ...
                            (selectedSubject) {
                              ...
                              stopwatchBloc.add(
                                  UpdateSelectedSubject(selectedSubject.name));
                            },
                          ),
                          child: Container(
                            // autogroup28nm4d7 (33sU1idJd3sh2HiUaS28Nm)
                            margin: EdgeInsets.fromLTRB(
                                96 * fem, 0 * fem, 95.33 * fem, 15 * fem),
                            width: double.infinity,
                            height: 43 * fem,
                            decoration: BoxDecoration(
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                32 * fem, 10 * fem, 32.33 * fem, 52 * fem),
                            padding: EdgeInsets.fromLTRB(
                                64 * fem, 74 * fem, 64 * fem, 73 * fem),
                            width: double.infinity,
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: AssetImage(
                                    'assets/page-1/images/vector-v2D.png'),
                              ),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                ...
                                BlocBuilder<StopwatchBloc, StopwatchState>(
                                  builder: (context, state) {
                                    return Container(
                                      margin: EdgeInsets.fromLTRB(
                                          0 * fem, 0 * fem, 2 * fem, 44 * fem),
                                      child: Text(
                                        state
                                            .formattedAccumulatedTime, // 누적 시간을 포맷하여 표시
                                        textAlign: TextAlign.center,
                                        style: SafeGoogleFont(
                                          'Inter',
                                          fontSize: 20 * ffem,
