                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              // groupWA9 (0:275)
                              margin: EdgeInsets.fromLTRB(153.97*fem, 0*fem, 0*fem, 3.85*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                            ...
                            Container(
                              // 5cZ (0:284)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 26.8*fem),
                              width: double.infinity,
                              child: Text(
                                '국어',
                                textAlign: TextAlign.center,
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 122.76*fem, 38*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          // vectorPFs (0:279)
                                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.81*fem),
                                          width: 19.96*fem,
                                          height: 1.19*fem,
                                          child: Image.asset(
                                            'assets/page-1/images/vector.png',
                                  ...
                                  Container(
                                    // uED (0:285)
                                    margin: EdgeInsets.fromLTRB(0*fem, 4.2*fem, 0*fem, 0*fem),
                                    child: Text(
                                      '수학',
                                      textAlign: TextAlign.center,
                                      style: SafeGoogleFont (
                            ...
                            Container(
                              // groupjj3 (0:281)
                              margin: EdgeInsets.fromLTRB(149.81*fem, 0*fem, 5.2*fem, 0*fem),
                              width: double.infinity,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
