        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(18*fem, 12*fem, 17.67*fem, 35*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  // mobilesignalRo7 (2313:55)
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.03*fem, 0*fem),
                                  width: 17*fem,
                                  height: 10.67*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/mobile-signal-wxD.png',
                                    width: 17*fem,
                                    height: 10.67*fem,
                                  ),
                                ),
                                Container(
                                  ...
                                  height: 10.97*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/wifi-xwj.png',
                                    width: 15.27*fem,
                                    height: 10.97*fem,
                                  ),
                                ),
                                Container(
                                  ...
                                  height: 11.33*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/battery-gQh.png',
                                    width: 24.33*fem,
                                    height: 11.33*fem,
                                  ),
                                ),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(32*fem, 0*fem, 32.33*fem, 52*fem),
                    padding: EdgeInsets.fromLTRB(64*fem, 74*fem, 64*fem, 71*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
