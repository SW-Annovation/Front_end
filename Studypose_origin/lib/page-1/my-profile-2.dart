        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(32*fem, 12*fem, 11*fem, 125*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    // frame13j4u (2327:497)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6.67*fem, 136*fem),
                    width: 340.33*fem,
                    height: 20*fem,
                    child: Container(
                      // group33LV (2327:498)
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(102*fem, 0*fem, 0*fem, 107*fem),
                    child: Row(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(82*fem, 0*fem, 103*fem, 0*fem),
                    width: double.infinity,
                    height: 44*fem,
                    decoration: BoxDecoration (
                      color: Color(0xff000000),
